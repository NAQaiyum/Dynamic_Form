            ...
            <td colspan="2" class="text-justify" >
                ...
                <div class="row" >
                    <div class="col-md-6" style="width: 30%">
                        ...
                        <div>
                        {!! QrCode::size(200)->backgroundColor(250,235,240)->generate($getData && $getData->certificate ? asset($getData->certificate) : route("frontend::invoice.print",['certificate_origin_no' => $getData->certificate_origin_no])) !!}
                            <p class="pl-4">{{$getData->certificate_origin_no}}</p>
                        </div>    
                    </div>
