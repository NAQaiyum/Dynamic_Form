...
<form method="POST" action="{{route('frontend::invoice.save')}}"  enctype="multipart/form-data">
    ...
    <table class="table table-bordered table-size">
        <tbody>
            <tr>
                <td style="width: 50%">
                    Exporter (Name & Address)<br>
                    <div class="form-group">
                        <input type="text" class="form-control" name="ex_name" placeholder="Name" required>
                    </div>
                    <div class="form-group">
                        <lable>Certificate No:<lable>
                        <input type="string" class="form-control" name="certificate_origin_no" placeholder="" >
                    </div>
                    <div class="form-group">
                        <lable>Serial No:<lable>
                        <input type="string" class="form-control" name="serialno" placeholder="" required > 
                    </div>
                ...
                <td colspan="2">
                    <div class="flex-container">
                        ...
                        <div class="column new">
                            ...
                            <textarea type="text" style="width: 40%;"  name="quantity_unit"></textarea>
                        </div>
                    </div>
                </td>
            </tr>
