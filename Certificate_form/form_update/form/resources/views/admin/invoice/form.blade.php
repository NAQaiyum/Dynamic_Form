            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="certificate_origin_no" placeholder="Title" value="{{ $data ? $data->certificate_origin_no : null }}" readonly>
                        <input type="hidden" class="form-control" name="id" placeholder="id" value="{{ $data ? $data->id : null }}">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="mb-3">
                        <label for="field-1" class="form-label">Certificate</label>
                        <div class="mb-1">
