    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                ...
                <!--<a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" href="{{route('Auth::logout')}}" class="dropdown-item notify-item">-->
            ...
            <li class="">
                <a class="nav-link dropdown-toggle arrow-none waves-effect waves-light"href="{{route('Auth::logout')}}">
                    <i class="fe-log-out"></i>
                    <span>Logout</span>
                </a>
            </li>
        ...
        <div class="logo-box">
            <a href="{{route('dashboard')}}" class="logo logo-dark text-center">
                <span class="logo-sm">
                    <img src="{{ asset('assets/images/logo-sm.png') }}" alt="" height="22" style="height: 70px;">
                    <!-- <span class="logo-lg-text-light">UBold</span> -->
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('assets/images/logo-dark.png') }}" alt="" height="20" style="height: 70px;">
            ...
            <a href="{{route('dashboard')}}" class="logo logo-light text-center">
                ...
                <span class="logo-lg">
                    <img src="{{ asset('assets/images/logo-light.png') }}" alt="" height="20" style="height: 70px;">
                </span>
            </a>
        </div>
